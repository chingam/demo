...
//            $(this).find('i.icon').toggleClass('icon-resize-small icon-resize-full');
//            mytable.api().draw();
//            if ($(this).is('[data-fixright]') || $(this).is('[data-fixleft]')) {
//                mytable.api().fixedColumns().update();
//            }
...
//            $(this).parents('.dataTables_wrapper').find('.fullscreenbuttonarea').html('<button class="fullscreenbutton btn btn-info" type="button"><i class="icon icon-resize-full icon-white"></i> Fullscreen</button>');
//        }
...
//    }
//    var refresh;
//    function setRefresh(rate, instarefresh) {
...
//            // If action has occured in the last 10 seconds
//            if (table.refreshdebounce || $(table).parents('.tablewrapper').find('.brandnew').length > 0) {
//                //Set this function to fire again in 10 seconds time
//                console.log('set timer to 10 seconds');
//                setRefresh(10000);
//            } else {
...
//                setRefresh(parseInt($(table).parents('.dataTables_wrapper').find('.ajax-table-refresh').val()) * 1000, true);
//            }
//        }, rate);
//    }
...
////                                    $(table).parents('.dataTables_wrapper').find('.dataTables_filter input[type="search"]').unbind().on('keydown', function(e){startDebounce(e);});
...
//                                            }
//                                            window.clearInterval(refresh);
//                                            setRefresh(parseInt($(this).val()) * 1000, true);
//                                        });
//                                        $(table).parents('.dataTables_wrapper').on('click', '.refreshbutton', function () {
//                                            window.clearInterval(refresh);
//                                            setRefresh(parseInt($(table).parents('.dataTables_wrapper').find('.ajax-table-refresh').val()) * 1000, true);
//                                        });
//                                        setRefresh(parseInt(rate * 1000), false);
//                                        needsametaboot = true;
//                                    }
...
//    row.find('div.controls:has(input[type="radio"].include:ontrols:has(input[type="checkbox"].include)').removeClass('disabledradioorcheckbox');
//    row.find(":input:visible:first").focus();
